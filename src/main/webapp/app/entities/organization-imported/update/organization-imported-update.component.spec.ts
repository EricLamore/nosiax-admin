...
describe('OrganizationImported Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call ImportOrganizations query and add missing value', () => {
      ...
      const employee: IImportOrganizations = { id: 77298 };
      organizationImported.employee = employee;
      ...
      const additionalImportOrganizations = [employee];
    ...
    it('Should update editForm', () => {
      const organizationImported: IOrganizationImported = { id: 456 };
      const employee: IImportOrganizations = { id: 24057 };
      organizationImported.employee = employee;
      ...
      expect(comp.importOrganizationsSharedCollection).toContain(employee);
    });
  });
