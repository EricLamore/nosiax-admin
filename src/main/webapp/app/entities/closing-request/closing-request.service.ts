...
export class ClosingRequestService {
  ...
  protected convertDateFromClient(closingRequest: IClosingRequest): IClosingRequest {
    const copy: IClosingRequest = Object.assign({}, closingRequest, {
      idxAgency: closingRequest.idxAgency && closingRequest.idxAgency.isValid() ? closingRequest.idxAgency.toJSON() : undefined,
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      res.body.idxAgency = res.body.idxAgency ? moment(res.body.idxAgency) : undefined;
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((closingRequest: IClosingRequest) => {
        closingRequest.idxAgency = closingRequest.idxAgency ? moment(closingRequest.idxAgency) : undefined;
