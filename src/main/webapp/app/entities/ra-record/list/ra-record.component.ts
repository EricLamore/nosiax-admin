...
export class RaRecordComponent implements OnInit {
  raRecords?: IRaRecord[];
  isLoading = false;
  totalItems = 0;
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.raRecordService
      ...
      .subscribe({
        next: (res: HttpResponse<IRaRecord[]>) => {
  ...
  protected onSuccess(data: IRaRecord[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
