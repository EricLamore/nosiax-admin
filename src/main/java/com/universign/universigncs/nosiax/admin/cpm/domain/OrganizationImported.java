...
public class OrganizationImported implements Serializable {
  ...
  private ImportOrganizations organizationImported;
  ...
  public ImportOrganizations getOrganizationImported() {
    return this.organizationImported;
  }

  public void setOrganizationImported(ImportOrganizations importOrganizations) {
    this.organizationImported = importOrganizations;
  }

  public OrganizationImported organizationImported(ImportOrganizations importOrganizations) {
    this.setOrganizationImported(importOrganizations);
    return this;
  }
