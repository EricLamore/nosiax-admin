...
public class ClosingRequest implements Serializable {
    ...
    public Agency getIdxAgency() {
        return idxAgency;
    }

    public ClosingRequest idxAgency(Agency agency) {
        this.idxAgency = agency;
        return this;
    }

    public void setIdxAgency(Agency agency) {
        this.idxAgency = agency;
    }
