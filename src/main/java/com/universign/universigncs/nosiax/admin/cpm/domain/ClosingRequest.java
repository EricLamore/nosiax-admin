...
public class ClosingRequest implements Serializable {
    ...
    private ZonedDateTime idxAgency;
    ...
    public ZonedDateTime getIdxAgency() {
        return idxAgency;
    }

    public ClosingRequest idxAgency(ZonedDateTime idxAgency) {
        this.idxAgency = idxAgency;
        return this;
    }

    public void setIdxAgency(ZonedDateTime idxAgency) {
        this.idxAgency = idxAgency;
    }
