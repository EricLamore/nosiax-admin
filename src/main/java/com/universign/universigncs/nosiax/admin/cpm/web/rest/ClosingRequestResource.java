...
public class ClosingRequestResource {
    ...
    private final ClosingRequestService closingRequestService;

    public ClosingRequestResource(ClosingRequestService closingRequestService) {
        this.closingRequestService = closingRequestService;
    }
    ...
    public ResponseEntity<ClosingRequest> createClosingRequest(@RequestBody ClosingRequest closingRequest) throws URISyntaxException {
        ...
        ClosingRequest result = closingRequestService.save(closingRequest);
    ...
    public ResponseEntity<List<ClosingRequest>> getAllClosingRequests(Pageable pageable) {
        ...
        Page<ClosingRequest> page = closingRequestService.findAll(pageable);
    ...
    public ResponseEntity<ClosingRequest> getClosingRequest(@PathVariable Long id) {
        ...
        Optional<ClosingRequest> closingRequest = closingRequestService.findOne(id);
    ...
    public ResponseEntity<Void> deleteClosingRequest(@PathVariable Long id) {
        ...
        closingRequestService.delete(id);
